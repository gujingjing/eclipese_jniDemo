...
public class JNI {
	...
	public native void BackWeak(byte[] p1, byte[] p2, int p3, int p4, int[] p5,
			int[] p6, int p7, byte[] p8, int p9, int p10);

	public native void BackWeak2(byte[] p1, int p2, int p3, int p4, int p5,
			byte[] p6, int p7, int p8);

	public native void BackWeakLine(int[] p1, int[] p2, int p3, int p4,
			int[] p5, int[] p6, float p7, int p8, int p9);

	public native void BackWeakOne(int[] p1, int[] p2, int p3, int p4, int p5,
			int p6, byte[] p7, int p8, int p9);

	public native void CColorBalance(boolean p1, int p2, int p3, int p4,
			int p5, byte[] p6, int p7, int p8);
	...
	public native void ExclusionEx2(byte[] p1, byte p2, byte p3, byte p4,
			double p5);
	...
	public native void GaussIIRBlurBrush(int[] p1, int p2, int p3, int p4,
			int p5);

	public native void GaussIIRBlurImage(byte[] p1, int p2, int p3, int p4,
			int p5);
	...
	public native void OldImage(byte[] p1, int p2, int p3, byte[] p4, int p5,
			int p6);

	public native void PinLightEx(byte[] p1, byte[] p2);

	public native void PtChangeByRotate(byte[] p1, double p2, double p3,
			double p4);
	...
	public native void Resample(byte[] p1, int p2, int p3, int p4, byte[] p5,
			int p6, int p7);

	public native void SSkinbeautify(int[] p1, int p2, int p3, int p4, int p5,
			int p6, double p7);
	...
	public native void SetColorImage(byte[] p1, int p2, int p3, int p4, int p5,
			int p6);
	...
	public native void StyleGP1(int[] p1, int[] p2, int p3, int p4, byte[] p5,
			int p6);

	public native void StyleGP2(int[] p1, int[] p2, int p3, int p4, byte[] p5,
			int p6);
	...
	public native void StyleLomoAP1(int[] p1, int[] p2, int p3, int p4,
			byte[] p5, int p6);

	public native void StyleLomoAP2(int[] p1, int[] p2, int p3, int p4,
			byte[] p5, int p6);
	...
	public native void StyleOldPhotoP1(int[] p1, int[] p2, int p3, int p4,
			byte[] p5, int p6);

	public native void StyleOldPhotoP2(int[] p1, int[] p2, int p3, int p4,
			byte[] p5, int p6);
	...
	public native byte[] deal(byte[] p1, int p2, int p3, int p4, int p5,
			String p6);
